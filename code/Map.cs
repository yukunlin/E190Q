...
namespace DrRobot.JaguarControl
{
    public class Map
    {
        ...
        public Map()
        {
            ...
            numMapSegments = File.ReadAllLines(@"C:\Users\gkhadge\Downloads\extended_map3.csv").Length;
            ...
            // open CSV file
            var reader = new StreamReader(File.OpenRead(@"C:\Users\gkhadge\Downloads\extended_map3.csv"));
            int r = 0;
